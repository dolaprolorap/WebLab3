<template>
  ...
  >
    <q-form @submit="onSubmit" class="q-gutter-md">
      <q-input filled v-model="login" label="Create Login" />
      <q-input filled v-model="password" label="Your password" />
      <q-input filled v-model="passwordRepeat" label="Repeat your password" />
...
const onSubmit = () => {
  if (password.value === passwordRepeat.value) {
    axios
      .post(backendServer + '/api/Authentication/registrate', {
        login: login.value,
